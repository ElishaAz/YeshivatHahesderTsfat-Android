...
/*
 * Copied from: https://gist.github.com/konrad-kaminski/d7808070f4218349674589e1dc97264a
 *
...
internal class CountDownLatchImpl(initialCount: Int) : CountDownLatch {
    ...
    private val continuations =
        mutableListOf<Continuation<Unit>>() // should probably use LockFreeLinkedListNode instead
