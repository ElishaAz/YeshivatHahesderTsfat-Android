 ...
 *
 * For yeshivathahesder, given the following conceptual tree:
 * root
 * +-- Albums
 * |    +-- Album_A
 * |    |    +-- Song_1
 ...
 * any other direct children. Taking the media ID of "Albums" ("Albums" in this yeshivathahesder),
...
public final class BrowseTree {
    ...
    tsfat.yeshivathahesder.channel.uamp.media.library.MusicSource musicSource, @org.jetbrains.annotations.Nullable()
