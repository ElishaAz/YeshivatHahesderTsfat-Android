...
suspend fun downloadCatalog(context: Context): DriveCatalog {
    ...
    return catalog ?: DriveCatalog(emptyList())
}
...
suspend fun uploadCatalog(context: Context): DriveCatalog? {
    ...
    val lockRef = db.collection("catalog").document("lock")
    ...
    return withContext(Dispatchers.IO) {
        ...
        val catalogRef = db.collection("catalog").document("audio_catalog")
