...
//        mediaSource = JsonSource(source = remoteJsonSource)
        mediaSource = FirebaseSource(this, serviceScope)
        serviceScope.launch {
            mediaSource.load()
        }
 ...
 */
const val NETWORK_FAILURE = "tsfat.yeshivathahesder.channel.uamp.media.session.NETWORK_FAILURE"

/** Content styling constants */
private const val CONTENT_STYLE_BROWSABLE_HINT = "channel.media.browse.CONTENT_STYLE_BROWSABLE_HINT"
private const val CONTENT_STYLE_PLAYABLE_HINT = "channel.media.browse.CONTENT_STYLE_PLAYABLE_HINT"
private const val CONTENT_STYLE_SUPPORTED = "channel.media.browse.CONTENT_STYLE_SUPPORTED"
